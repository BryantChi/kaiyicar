        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 text-center">
                <div class="footer-info">
                    ...
                    <h3><a href="{{ Route('index') }}" class="logo mr-auto"><img
                    ...
                    <div class="social-links mt-3">
                        {{-- <a href="https://line.me/R/ti/p/%40bge1748q" class="messenger"><i class="bx bxl-messenger"></i></a> --}}
                        <a href="https://line.me/R/ti/p/%40psg3611g" rel=”nofollow”><svg
                        ...
                        <a href="https://www.facebook.com/kaiyicartainan" class="facebook" rel=”nofollow”><i
                                class="bx bxl-facebook"></i></a>
                        <a href="https://www.youtube.com/channel/UCShnaLEC1wiP7whxVdU4w6Q/featured" class="youtube"
                            rel=”nofollow”><i class="bx bxl-youtube"></i></a>
                        {{-- <a href="#" class="google-plus"><i class="bx bxl-skype"></i></a> --}}
                        {{-- <a href="https://richfuloutlet.pixnet.net/blog" class="blogger"><i class="bx bxl-blogger"></i></a> --}}
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 footer-links">
                {{-- <p>
                    <a target="_blank"
                        href="https://www.google.com/maps/place/702%E5%8F%B0%E5%8D%97%E5%B8%82%E5%8D%97%E5%8D%80%E4%B8%AD%E8%8F%AF%E5%8D%97%E8%B7%AF%E4%BA%8C%E6%AE%B5151%E8%99%9F/@22.9613701,120.1895483,17z/data=!3m1!4b1!4m5!3m4!1s0x346e75c78e8488bd:0xac794493fae9880c!8m2!3d22.9613701!4d120.191737"><span
                            class="text">台南市南區中華南路2段151號</span></a><br>
                    <strong>TEL:</strong> <a href="tel://06262-8699"><span class="text">(06)262-8699</span></a> <br><br>

                    <strong>Email:</strong> <a href="mailto:kaiyicar@gmail.com"><span
                            class="text">kaiyicar@gmail.com</span></a><br>
                </p> --}}

                <ul>
                    <li><i class="bx bx-chevron-right"></i> <strong>ADDRESS：</strong>&nbsp; <a target="_blank"
                            href="https://www.google.com/maps/place/702%E5%8F%B0%E5%8D%97%E5%B8%82%E5%8D%97%E5%8D%80%E4%B8%AD%E8%8F%AF%E5%8D%97%E8%B7%AF%E4%BA%8C%E6%AE%B5151%E8%99%9F/@22.9613701,120.1895483,17z/data=!3m1!4b1!4m5!3m4!1s0x346e75c78e8488bd:0xac794493fae9880c!8m2!3d22.9613701!4d120.191737"><span
                                class="text">台南市南區中華南路2段151號</span></a></li>
                    <li><i class="bx bx-chevron-right"></i> <strong>TEL：</strong>&nbsp; <a href="tel://06262-8699"><span
                                class="text">(06)262-8699</span></a></li>
                    <li><i class="bx bx-chevron-right"></i> <strong>Email：</strong>&nbsp; <a
                            href="mailto:kaiyicar@gmail.com"><span class="text">kaiyicar@gmail.com</span></a></li>
                </ul>
            </div>

            <div class="col-lg-4 col-md-6">
                <div class="footer-info mb-4">
                    <a href="https://line.me/R/ti/p/%40psg3611g"><img class="img-thumbnail mx-1" src="{{ asset('images/line_qrcode.png') }}" style="width: 10rem;"
                        alt=""></a>
                    <a href="https://www.facebook.com/kaiyicartainan"><img class="img-thumbnail mx-1" src="{{ asset('images/kaiyi_fb.jpg') }}" style="width: 9.7rem;"
                        alt=""></a>
                </div>
            </div>
          ...
          <h4>快速連結</h4>
          <ul>
            <li><i class="bx bx-chevron-right"></i> <a href="{{ Route('Featured') }}">Home</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="{{ Route('AboutUs') }}">關於瑞渥</a></li> --}}
            {{-- {{ Route('AboutUs') }} --}}
            {{-- <li><i class="bx bx-chevron-right"></i> <a href="{{ Route('FeaturedCar') }}">美洲精選</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="{{ Route('ChooseOwn') }}">自辦外匯車</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="{{ Route('ContactUs') }}">聯絡我們</a></li>
          </ul>
        </div> --}}
...
<div class="container">
    <div class="copyright">
        &copy; Copyright <strong><span>KaiyiCar</span>&nbsp;2021</strong>. All Rights Reserved
    </div>
    <div class="credits">
